...
import com.telefonica.centroseducativos.NoSuchUsuarioException;
import com.telefonica.centroseducativos.model.Usuario;
import com.telefonica.centroseducativos.model.impl.UsuarioImpl;
import com.telefonica.centroseducativos.model.impl.UsuarioModelImpl;
...
public class UsuarioPersistenceImpl extends BasePersistenceImpl<Usuario>
    ...
    protected Usuario toUnwrappedModel(Usuario usuario) {
        ...
        usuarioImpl.setCursoAcademico(usuario.getCursoAcademico());
        usuarioImpl.setHaContestadoLaEncuesta(usuario.isHaContestadoLaEncuesta());
        usuarioImpl.setIdrol(usuario.getIdrol());
        usuarioImpl.setIdce(usuario.getIdce());
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.telefonica.centroseducativos.model.Usuario")));
