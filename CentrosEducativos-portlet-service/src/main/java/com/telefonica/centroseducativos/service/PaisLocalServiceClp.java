 ...
 * @generated
 */
public class PaisLocalServiceClp implements PaisLocalService {
    ...
    public PaisLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName10 = "fetchPais";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getPais";
        ...
        _methodName13 = "getPaises";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getPaisesCount";
    ...
    public com.telefonica.centroseducativos.model.Pais addPais(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(pais) });
        } catch (Throwable t) {
        ...
        return (com.telefonica.centroseducativos.model.Pais) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.telefonica.centroseducativos.model.Pais createPais(int idpais) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { idpais });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.centroseducativos.model.Pais deletePais(int idpais)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { idpais });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.centroseducativos.model.Pais fetchPais(int idpais)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { idpais });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.centroseducativos.model.Pais getPais(int idpais)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { idpais });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.telefonica.centroseducativos.model.Pais> getPaises(
        ...
        return (java.util.List<com.telefonica.centroseducativos.model.Pais>) ClpSerializer.translateOutput(returnObj);
    }
