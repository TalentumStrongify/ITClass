...
/**
 * Provides the local service interface for EvaluacionesCE. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EvaluacionesCELocalServiceUtil
...
public interface EvaluacionesCELocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link EvaluacionesCELocalServiceUtil} to access the evaluaciones c e local service. Add custom service methods to {@link com.telefonica.centroseducativos.service.impl.EvaluacionesCELocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
