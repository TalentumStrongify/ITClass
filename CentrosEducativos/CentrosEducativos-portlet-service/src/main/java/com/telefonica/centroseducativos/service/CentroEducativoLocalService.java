...
/**
 * Provides the local service interface for CentroEducativo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CentroEducativoLocalServiceUtil
...
public interface CentroEducativoLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link CentroEducativoLocalServiceUtil} to access the centro educativo local service. Add custom service methods to {@link com.telefonica.centroseducativos.service.impl.CentroEducativoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
