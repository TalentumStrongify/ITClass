 ...
 * @generated
 */
public class RolUsuarioLocalServiceClp implements RolUsuarioLocalService {
    ...
    public RolUsuarioLocalServiceClp(
    ...
    public com.telefonica.centroseducativos.model.RolUsuario addRolUsuario(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(rolUsuario) });
        } catch (Throwable t) {
        ...
        return (com.telefonica.centroseducativos.model.RolUsuario) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.telefonica.centroseducativos.model.RolUsuario createRolUsuario(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { idrol });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.centroseducativos.model.RolUsuario deleteRolUsuario(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { idrol });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.centroseducativos.model.RolUsuario fetchRolUsuario(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { idrol });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.centroseducativos.model.RolUsuario getRolUsuario(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { idrol });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.telefonica.centroseducativos.model.RolUsuario> getRolUsuarios(
        ...
        return (java.util.List<com.telefonica.centroseducativos.model.RolUsuario>) ClpSerializer.translateOutput(returnObj);
    }
