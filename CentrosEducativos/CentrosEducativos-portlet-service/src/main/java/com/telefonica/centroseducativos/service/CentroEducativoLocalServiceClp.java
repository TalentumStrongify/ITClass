 ...
 * @generated
 */
public class CentroEducativoLocalServiceClp
    ...
    public CentroEducativoLocalServiceClp(
    ...
    public com.telefonica.centroseducativos.model.CentroEducativo addCentroEducativo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(centroEducativo) });
        } catch (Throwable t) {
        ...
        return (com.telefonica.centroseducativos.model.CentroEducativo) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.telefonica.centroseducativos.model.CentroEducativo createCentroEducativo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { idce });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.centroseducativos.model.CentroEducativo deleteCentroEducativo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { idce });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.centroseducativos.model.CentroEducativo fetchCentroEducativo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { idce });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.centroseducativos.model.CentroEducativo getCentroEducativo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { idce });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.telefonica.centroseducativos.model.CentroEducativo> getCentroEducativos(
        ...
        return (java.util.List<com.telefonica.centroseducativos.model.CentroEducativo>) ClpSerializer.translateOutput(returnObj);
    }
