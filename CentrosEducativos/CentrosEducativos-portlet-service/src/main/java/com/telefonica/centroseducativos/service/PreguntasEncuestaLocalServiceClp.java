 ...
 * @generated
 */
public class PreguntasEncuestaLocalServiceClp
    ...
    public PreguntasEncuestaLocalServiceClp(
    ...
    public com.telefonica.centroseducativos.model.PreguntasEncuesta addPreguntasEncuesta(
        ...
        return (com.telefonica.centroseducativos.model.PreguntasEncuesta) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.telefonica.centroseducativos.model.PreguntasEncuesta createPreguntasEncuesta(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { numpregunta });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.centroseducativos.model.PreguntasEncuesta deletePreguntasEncuesta(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { numpregunta });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.centroseducativos.model.PreguntasEncuesta fetchPreguntasEncuesta(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { numpregunta });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.centroseducativos.model.PreguntasEncuesta getPreguntasEncuesta(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { numpregunta });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.telefonica.centroseducativos.model.PreguntasEncuesta> getPreguntasEncuestas(
        ...
        return (java.util.List<com.telefonica.centroseducativos.model.PreguntasEncuesta>) ClpSerializer.translateOutput(returnObj);
    }
